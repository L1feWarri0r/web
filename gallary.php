...
<body>
    ...
    <div class="main_content">
        <h3>Gallery</h3>
        <br><br>
        <img src="img1.jpg" alt="image" class="image">
        <img src="classroom.jpeg" alt="image" class="image">
        <img src="tabletenis.jpg" alt="Table Tenis" class="image"><br><br>
        <img src="chesh.jpg" alt="image" class="image">  
        <img src="carrom.jpg" alt="image" class="image">
        <img src="badminton.jpg" alt="image" class="image"><br><br>
        <img src="swimming.jpeg" alt="image" class="image">
        <img src="basketball.jpeg" alt="image" class="image">
        <img src="library.jpg" alt="image" class="image"><br><br>
      <img src="library2.jpg" alt="image" class="image">  
      <img src="computer lab.jpg" alt="image" class="image"> 
      <img src="im2.jpg" alt="image" class="image"><br><br>
      <img src="im3.jpg" alt="image" class="image">
      <img src="img.jpeg" alt="image" class="image">
      <img src="exam hall.jpg" alt="image" class="image"><br><br>
      <img src="exam hall2.jpg" alt="image" class="image">
      <img src="im1.jpg" alt="image" class="image">
      <img src="im2.jpg" alt="image" class="image">
