...
<br><br><strong>Mission and Vision</strong>

<p><b>The mission of ‘Library System’ is to provide comprehensive resources and services in support of the research, teaching, and learning needs of the Vidyapith community. To fulfill this mission, the Library commits to:</b>
<ul class= "faculty_members">
<li> Build collections and create tools to support research and learning;</li>
<li> Maximize access to and promote the use of internal as well as external information resources;</li>
<li> Ensure the preservation and long-lasting availability of library resources;</li>
<li> Create attractive and comfortable  physical and virtual environments for study, and research;</li>
<li> Collaborate with vidyapith faculty and researchers to enrich the collection services.</li></br></br>
The Library System ensures that its collections remain forward-looking, diverse in breadth and form, open to browsing, and of world-renowned quality.</p>
<br><br>
<img src="library.jpg" alt="image" class="imagek">
<img src="library2.jpg" alt="image" class="imagek">
</div>
</body>
</html>
