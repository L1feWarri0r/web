...
<head>
    ...
    <link href="indoorgames.css" rel="stylesheet" type="text/css">
...
<body>
    ...
    <div class="main_content">
       <h2>Sports</h2>
       <br><br><strong>
       Play Field (Indoors)<br><br><br></strong>
       <ul class= "faculty_members">
        <li> Table Tennis Hall (Gyan Mandir)</li>

        <li>Partially enclosed Badminton Court (Gyan Mandir)</li>
        <li>Multigym (16 Stations) installed at Vidula Maidan.</li>
</ul>
        <img src="tabletenis.jpg" alt="Table Tenis" class="image">
